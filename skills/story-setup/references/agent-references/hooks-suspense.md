...
使用方法：只在本章承担悬念功能时对照此表判断强度。过渡/低压章可以无硬悬念，但仍要有兑现、状态变化和下一步；正文章通常 1-2 级，关键章通常 3 级以上，服从题材和章节定位。
...
- [ ] **章末有余势**：是否留下问题、决定、行动、关系变化、阶段目标或情绪余势之一；低压章不强求未解谜团
- [ ] **下行力度适中**：挫折是否控制在"小波折"范围，没有导致节奏断裂
- [ ] **震惊有层次**：震惊是否从点 → 网 → 深度递进，而非一次性爆发
- [ ] **道具变化可视化**：震惊递进是否有明确的视觉/物理变化支撑
- [ ] **爽感有层次**：阶段总体是否升级，同时允许强弱错落，避免每次都比上次更炸造成刺激通胀
- [ ] **续接不过载**：问题解决后可先给低压收益/关系回收；进入下一轮时是否有明确目标或挑战，而非立刻机械加危机
