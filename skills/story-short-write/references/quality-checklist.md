...
- [ ] 有核心事件
- [ ] 局势有变化
- [ ] “收一个”：本节/本章兑现了哪笔期待，或给出了什么进展/反馈
- [ ] “开一个”：留下了什么有意义的下一步（问题/决定/行动/关系变化/情绪余势）
...
### 章尾
- [ ] 结尾落在变化上
- [ ] 有危机/决定/行动/发现/关系变化/情绪余势中的至少一个；非付费点/非高潮段不强求硬悬念
- [ ] 不是总结式结尾
- [ ] 拉住读者翻下一页
- [ ] 钩子诚信：后文能真实承接，不撤回、不降格成误会、不跳段逃债
- [ ] 强反转/爆点有铺垫，没有为了“节节翻转”临时加码
