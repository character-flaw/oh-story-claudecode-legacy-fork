...
| 故事阶段 | 推荐类型 | 强度 |
|----------|---------|------|
| 第 1 章 | 系统激活 / 截断 / 危机升级 | 通常强，服从题材契约 |
| 2-3 章 | 选择 / 信息差 / 情感转折 | 中到强 |
| 中期日常 | 决定 / 关系变化 / 情绪定格 / 信息差 | 弱到中 |
| 高潮前 | 危机升级 / 悬念预知 | 强 |
| 大结局 | 时间跳跃 / 情感转折 | 收束 |

### 持续追读的底层规则

**钩子不等于悬崖断章，反转不等于章章标配，爆点也不等于唯一推进。**

每章真正的硬下限是“**收一个，开一个**”：

1. **收一个**：偿还一笔已有期待债，或至少支付利息。给出可见收益、答案、进展、关系反馈、情绪释放中的一种。
2. **变一个**：让目标 / 风险 / 信息 / 关系 / 资源 / 身份 / 情绪立场至少一项发生可指认的前后变化。
3. **开一个**：留下一个有意义的下一步推动力，可以是问题，也可以是决定、行动、关系变化、阶段目标或情绪余势。

强反转、强危机、强爆点只在开篇、升级、付费点、高潮前后等结构节点使用。低压、奖励、关系回收、信息整理章可以没有硬悬念，但不能没有兑现、变化和下一步。连续使用同强度、同机制的钩子会造成刺激通胀，应主动错落。

**钩子诚信**：
- 章尾承诺的危机、选择或发现，下一章要尽快承接，不能撤回、降格成误会或切走逃债。
- 不隐瞒角色自然知道、读者理应知道的关键信息来制造假谜团。
- 信息差必须有重要性锚点：读者要先知道“为什么值得关心”，再允许暂时不知道答案。
...
- 章末钩子宜短而具体；长度服从场景，不使用“固定字数必然提升完读率”的伪指标
...
- [ ] 本章“收一个”：兑现了哪笔期待，或支付了什么利息
- [ ] 本章“变一个”：七类状态中哪一项发生了可见变化
- [ ] 章尾“开一个”：留下问题/决定/行动/关系变化/阶段目标/情绪余势中的至少一种
- [ ] 钩子强度与章节阶段匹配（日常章不必强钩子）
- [ ] 连续两章不用同一种钩子
- [ ] 强反转/爆点有前置铺垫，不为“章章炸”临时加码
- [ ] 下一章能真实承接本章承诺，不撤回、不切走、不制造假悬念
