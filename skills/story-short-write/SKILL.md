...
2. **一个核心反转撑一篇，高频小反转推着走**。全篇只有一个书脊级核心反转（身份/动机/世界观级），所有铺垫为它服务、所有情绪为它蓄力；但行进途中每节仍要有小反转/小揭示/态度翻转做节奏燃料（真实爆款语料口径：约每800-1500字一次小翻转）。两者不冲突：核心反转是"一篇只能有一个"的骨架，小反转是"每节都要有"的肌肉，别把这条读成"全篇只准翻转一次"。不多线、不铺世界观。
